...
const NOZZLE_RULES = [
  ...
  {id:'salamander-1n-overhead',types:['salamander'],nozzle:'1N',points:1,maxWidth:736,maxDepth:406,minHeight:0,maxHeight:304,heightText:'0–304 mm above broiler top',page:'4-24',figure:'4-59',note:'Overhead option. Measure the internal broiler chamber. Locate in line with a vertical edge, 152–304 mm in front, and aim at the opening centre.'},
  {id:'salamander-1f-overhead',types:['salamander'],nozzle:'1F',points:1,maxWidth:787,maxDepth:393,minHeight:304,maxHeight:457,heightText:'304–457 mm above broiler top',page:'4-24',figure:'4-60',note:'Overhead option. Measure the internal broiler chamber. Locate on the opening centreline, 203–304 mm in front, and observe nozzle-tip orientation.'},
